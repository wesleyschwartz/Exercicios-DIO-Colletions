...
public class RefatoracaoExercicio3 {
    ...
    public static void main(String[] args) {
        ...
        //Set<Map.Entry<Integer, Contato>> agenda5 = new TreeSet<>(Comparator.comparing(new Function<Map.Entry<Integer, Contato>, String>() {
          /*  @Override
            public String apply(Map.Entry<Integer, Contato> nom) {
                return nom.getValue().getNome();
            }
        }));*/
        Set<Map.Entry<Integer, Contato>> agenda5 = new TreeSet<>(Comparator.comparing(nome -> nome.getValue().getNome()));
